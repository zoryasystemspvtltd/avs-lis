...
const MENUS: RoleMenuDef[] = [
  ...
  { menuKey: 'SETUP_REPORT_LAYOUT_CONFIGURATION', moduleName: 'ReportLayoutConfiguration', section: 'Masters', label: 'Report Layout Configuration', route: '/report-layout-configuration', order: 56 },
  { menuKey: 'SETUP_REPORT_TEMPLATE_CONFIGURATION', moduleName: 'ReportTemplateConfiguration', section: 'Masters', label: 'Report Template Configuration', route: '/report-template-configuration', order: 57 },
