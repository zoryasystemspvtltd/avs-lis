...
namespace Lis.Api.Controllers.Api
{
    ...
    public class UnitController : MasterApiControllerBase<UnitMaster>
    {
        ...
        [HttpPost, Route("")]
        public override HttpResponseMessage Post(UnitMaster item) => base.Post(item);

        [HttpPost, Route("Put")]
        public override HttpResponseMessage Put(UnitMaster item) => base.Put(item);

        [HttpPost, Route("Delete")]
        public override HttpResponseMessage Delete(UnitMaster item) => base.Delete(item);
    }
    ...
    public class MethodController : MasterApiControllerBase<MethodMaster>
    {
        ...
        [HttpPost, Route("")]
        public override HttpResponseMessage Post(MethodMaster item) => base.Post(item);

        [HttpPost, Route("Put")]
        public override HttpResponseMessage Put(MethodMaster item) => base.Put(item);

        [HttpPost, Route("Delete")]
        public override HttpResponseMessage Delete(MethodMaster item) => base.Delete(item);
    }
