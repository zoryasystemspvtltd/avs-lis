...
namespace Lis.Api
{
    public class SimpleInjectorInitializer
    {
                  ...
                  IAppBuilder app)
        {
            ...
            container.Register<ISampleCollectionManager, SampleCollectionManager>(Lifestyle.Scoped);
            ...
            container.Register<IReportTemplateManager, ReportTemplateManager>(Lifestyle.Scoped);
            ...
            container.Register<INotificationHttpTransport, NotificationHttpTransport>(Lifestyle.Scoped);
            container.Register<INotificationProviderFactory, NotificationProviderFactory>(Lifestyle.Scoped);
            container.Register<INotificationProcessor, NotificationProcessor>(Lifestyle.Scoped);
            container.Register<INotificationManager, NotificationManager>(Lifestyle.Scoped);
            container.Register<INotificationService, NotificationService>(Lifestyle.Scoped);
            container.Register<INotificationSecureDownloadManager, NotificationSecureDownloadManager>(Lifestyle.Scoped);
            ...
            container.Register<IMasterCrudManager<TestParameterMappingMaster>, TestParameterMappingCrudManager>(Lifestyle.Scoped);
