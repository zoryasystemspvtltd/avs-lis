/*
  Standalone SQL: RoleMenuPermission (menu-wise overlay on existing RoleModuleMappings).
  Does NOT alter UserModules, RoleModuleMappings, AspNetRoles, or AspNetUsers.
  Backward compatible: empty table = existing module-only behaviour.
*/
