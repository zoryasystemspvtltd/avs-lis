-- Patient Visit / Encounter management (standalone script)
...
IF NOT EXISTS (SELECT 1 FROM sys.foreign_keys WHERE name = N'FK_SaleInvoice_PatientVisit')
...
IF NOT EXISTS (SELECT 1 FROM sys.foreign_keys WHERE name = N'FK_TestRequestDetails_PatientVisit')
...
IF NOT EXISTS (SELECT 1 FROM sys.foreign_keys WHERE name = N'FK_RadiologyRequestDetail_PatientVisit')
